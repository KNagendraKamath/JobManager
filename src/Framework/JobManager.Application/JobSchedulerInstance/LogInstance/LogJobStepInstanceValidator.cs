...
internal sealed class LogJobStepInstanceValidator : AbstractValidator<LogJobStepInstanceCommand>
{
    public LogJobStepInstanceValidator(IJobStepInstanceValidation jobStepInstanceValidation)
    {
